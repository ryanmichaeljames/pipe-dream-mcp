...
{
    /// <summary>
    /// Parse Power Platform subcommand arguments
    /// </summary>
    public static PowerPlatformOptions ParsePowerPlatformArgs(string[] args)
    {
        var options = new PowerPlatformOptions();
...
/// <summary>
/// Command-line options for Power Platform subcommand
/// </summary>
public class PowerPlatformOptions
{
    public string? ConfigFile { get; set; }
    public string? ApiVersion { get; set; }
    public int? Timeout { get; set; }
